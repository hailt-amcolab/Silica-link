...
## Gợi ý liên kết giữa các app
- Orders ↔ Stock/Tasks/Physical Stock ↔ Ship&Co/Invoices.
- Products/Materials/BOM ↔ Production ↔ Materials Inventory/Stock Movements.
- Partners ↔ Orders/Invoices/Payouts/Rewards/Rules.
- Purchase Orders ↔ Supplier Portal/EDI ↔ Materials Inventory.

## Ghi chú vận hành
- Sử dụng Webhooks Kintone → Ruby Server cho các sự kiện: duyệt PO, lock quý, hoàn thành task, tạo invoice.
- Presigned URLs (S3) để đính PDF/CSV/labels vào bản ghi Kintone.
